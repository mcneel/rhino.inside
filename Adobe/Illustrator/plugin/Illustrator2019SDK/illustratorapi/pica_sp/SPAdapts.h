...
/** @ingroup Callers
	...
	compatibility with legacy versions of PICA, the application,
...
typedef struct SPAdaptersMessage {
	...
	/** For \c #kSPAdaptersAboutSelector, \c #kSPAdaptersLoadPluginSelector, \c #kSPAdaptersReleasePluginSelector,
	...
	/** For \c #kSPAdaptersAcquireSuiteHostSelector and \c #kSPAdaptersReleaseSuiteHostSelector.
	 	No longer used.*/
	ai::int32 acquired;					/* returned here */
...
typedef struct SPAdaptersSuite {
	...
	SPAPI SPErr (*AddAdapter)( SPAdapterListRef adapterList, struct SPPlugin *host, const char *name,
				ai::int32 version, SPAdapterRef *adapter );
